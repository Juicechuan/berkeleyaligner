...
import edu.berkeley.nlp.fig.basic.IdentityHashSet;
...
public class SystemUtils
{
	...
	{
		if (o == null || identityHashSet.contains(o)) return 0;
			...
			for (Field field : cl.getDeclaredFields())
			{
				...
				else
				{
					...
					if (!field.isSynthetic() && !field.isAnnotationPresent(SkipMemoryCount.class))
					{
						...
						sum += countApproximateMemoryUsage(object, identityHashSet);
					}
	...
	public static void main(String[] argv)
	{
		...
		System.out.println(countApproximateMemoryUsage(testObject,testObject2));
